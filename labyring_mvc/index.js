...
function updateModel(newSize) {
    ...
    for (let rowCounter = 0; rowCounter < newSize; rowCounter++) { /* will run set amount of times to create every object inside a row */
    ...
    setEntry(); /* Sets a random entrance */
    setExit(); /* Sets a random exit */
}
